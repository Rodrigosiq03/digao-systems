...
public class AdminUserProfilesController {
    ...
    public UserProfileResponse revoke(@PathVariable Long assignmentId, Authentication authentication) {
        return toResponse(userProfileAdminService.revoke(assignmentId, authentication.getName()));
    }
