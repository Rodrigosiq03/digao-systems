...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers(HttpMethod.GET, "/admin/groups/**").hasAnyRole("ADMIN_MASTER", "ADMIN")
            .requestMatchers(HttpMethod.GET, "/admin/users/*/vpn-access/**").hasAnyRole("ADMIN_MASTER", "ADMIN")
