...
public class AdminProfileCapabilitiesController {
    ...
    @GetMapping
    public ResponseEntity<java.util.List<ProfileCapabilityResponse>> list() {
        return ResponseEntity.ok(
            profileAdminService.listGrantedCapabilities().stream()
                .map(entity -> new ProfileCapabilityResponse(
                    entity.getId(),
