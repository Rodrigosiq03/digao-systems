      ...
      <div
        ...
        style={{
          background: theme === 'dark'
            ...
            : 'radial-gradient(900px 500px at 10% -20%, rgba(88,102,255,0.06), transparent 60%), radial-gradient(900px 500px at 90% -30%, rgba(82,212,255,0.06), transparent 65%), var(--bg)'
        }}
      >
